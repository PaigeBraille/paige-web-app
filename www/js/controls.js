...
function loadmacrolist() {
  ...
  //removeIf(production)
  var response =
    '[{"name":"","glyph":"","filename":"","target":"","class":"","index":0},{"name":"","glyph":"","filename":"","target":"","class":"","index":1},{"name":"","glyph":"","filename":"","target":"","class":"","index":2},{"name":"","glyph":"","filename":"","target":"","class":"","index":3},{"name":"","glyph":"","filename":"","target":"","class":"","index":4},{"name":"","glyph":"","filename":"","target":"","class":"","index":5},{"name":"","glyph":"","filename":"","target":"","class":"","index":6},{"name":"","glyph":"","filename":"","target":"","class":"","index":7},{"name":"","glyph":"","filename":"","target":"","class":"","index":8}]';
...
<<<<<<< HEAD
  if (typeof use_value !== "undefined")
    document.getElementById("autocheck_position").checked = use_value;
...
<<<<<<< HEAD
  if (target_firmware == "grbl" || target_firmware == "grbl-embedded") {
    ...
    document.getElementById("control_x_position").innerHTML =
      Control_get_position_value("X:", response);
    document.getElementById("control_y_position").innerHTML =
      Control_get_position_value("Y:", response);
    document.getElementById("control_z_position").innerHTML =
      Control_get_position_value("Z:", response);
  }
}
...
<<<<<<< HEAD
  ...
  if (feedrate == "XYfeedrate") {
    feedratevalue = parseInt(
      document.getElementById("control_xy_velocity").value
    );
    if (feedratevalue < 1 || isNaN(feedratevalue) || feedratevalue === null) {
      alertdlg(
        translate_text_item("Out of range"),
    ...
    feedratevalue = parseInt(
      document.getElementById("control_z_velocity").value
    );
    if (feedratevalue < 1 || isNaN(feedratevalue) || feedratevalue === null) {
      var letter = "Z";
...
function control_build_macro_button(index) {
  ...
  content +=
    "<button class='btn fixedbutton " +
    control_macrolist[index].class +
    "' type='text' ";
  if (entry.glyph.length == 0) {
    content += "style='display:none'";
  }
  content +=
    "onclick='macro_command (\"" +
    entry.target +
    '","' +
    entry.filename +
    "\")'";
